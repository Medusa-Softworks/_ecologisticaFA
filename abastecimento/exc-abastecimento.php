...
<body>
    <main>
        <section class="section">
            <div class="container">
                <h2 class="title is-2 has-text-centered">DATA </h2>
                <form action="./cad-abastecimentobd.php" method="POST" enctype="multipart/form-data">
                    <div class="field">
                        <label class="label" for="dia">Data:</label>
                        <div class="control">
                            <input class="input" type="date" name="data" id="dia" placeholder="Data:"
                            value="<?$resultado["dia"];?>"disabled> 
                        </div>
                    </div>
                    <div class="field">
                        <label class="label" for="quantidade">Quantidade</label>
                        <div class="control">
                            <input class="input" type="deicmal" name="quantidade" id="quantidade" placeholder="Quantidade:"
                            value="<?$resultado["quantidade"];?>"disabled>
                        </div>
                    </div>
                    <div class="field is-grouped">
                        <div class="control">
                            <label class="label" for="combustivel">Combustível</label>
                            <input class="input" type="text" name="combustivel" id="combustivel" placeholder="Número:"
